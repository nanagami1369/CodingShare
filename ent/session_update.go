...
func (su *SessionUpdate) SetDateOfExpiry(t time.Time) *SessionUpdate {
	su.mutation.SetDateOfExpiry(t)
	return su
}
...
func (su *SessionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.DateOfExpiry(); ok {
...
// SetDateOfExpiry sets the "dateOfExpiry" field.
func (suo *SessionUpdateOne) SetDateOfExpiry(t time.Time) *SessionUpdateOne {
	suo.mutation.SetDateOfExpiry(t)
	return suo
}
...
func (suo *SessionUpdateOne) sqlSave(ctx context.Context) (_node *Session, err error) {
	...
	if value, ok := suo.mutation.DateOfExpiry(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: session.FieldDateOfExpiry,
